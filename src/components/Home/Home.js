        ...
        return (
            <div className="container-main">
                ...
                <div>
                    ...
                    . The site will try to provide the best user experience for every newcomer and for every veteran in the GoT world. Each registered user will be able to try and add an additional story to the character's one, provided that he/she is adding a verified and legitimate information which is connection with the <b>Ice and Fire</b> novel.</p>
                </div>
                <div className="nav-container">
                <Link to="/heroes"  className="nav-container_link">Heroes</Link>
                <Link to="/houses"  className="nav-container_link">Houses</Link>
